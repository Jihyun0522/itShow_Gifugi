...
public class experience_basic extends AppCompatActivity {
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_experience_basic);
        context = this;
        ...
        mReference = mDatabase.getReference("content/activity"); // 변경값을 확인할 child 이름
